...
<img align="right" width="120" height="120" src="https://cm.magefan.com/catalog/product/cache/28b407cef1668fd0bdd6f36db3e8e2f0/i/c/icon-webp-convrter-shopware_1.jpg">
...
Unlike other online WebP converters, this WebP Extension for Shopware will free you from the hassles of manual WebP management. You won’t have to worry about converting your current or future images to WebP manually. 

This solution works automatically right after you install it. You don’t even have to configure it. This extension already has all of the settings filled in by default.

### Reduces Image File Size
The biggest benefit of WebP images is that it helps you reduce the size of the image files without significant quality loss. Our extension allows you to set the unique quality score for image compression. Correspondingly, you can tweak the settings to find the quality best for images on your store and image loading speed.

<p align="center">
  <img width="700" height="349" src="https://cm.magefan.com/catalog/Shopware/webp-converter_1.png">
</p>

### Images from External Websites in WebP
If you use any images from external websites, you can convert them to WebP format too, regardless of their origin. The extension will convert those images to WebP and store them on your server. 
<p align="center">
  <img width="700" height="349" src="https://cm.magefan.com/catalog/Shopware/webp-converter-advanced-settings.png">
</p>

### Excluded Image Folders
